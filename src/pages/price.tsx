...
const FR_URL = 'http://159.89.116.112/adriana/wp-json/wp/v2/pages/17';
const EN_URL = 'http://159.89.116.112/adriana/wp-json/wp/v2/pages/15';

class Price extends React.Component<any, IPageProps> {
