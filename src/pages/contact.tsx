...
const FR_URL = 'http://159.89.116.112/adriana/wp-json/wp/v2/pages/13';
const EN_URL = 'http://159.89.116.112/adriana/wp-json/wp/v2/pages/11';

class Contact extends React.Component<any, IPageProps> {
