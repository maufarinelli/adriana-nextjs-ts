...
const FR_URL = 'http://159.89.116.112/adriana/wp-json/wp/v2/pages/21';
const EN_URL = 'http://159.89.116.112/adriana/wp-json/wp/v2/pages/19';

class Blog extends React.Component<any, IPageProps> {
